...
install_pyqt5 () {
    ...
    curl -L -o /downloads/sip.tar.gz http://versaweb.dl.sourceforge.net/project/pyqt/sip/sip-${SPLASH_SIP_VERSION}/sip-${SPLASH_SIP_VERSION}.tar.gz && \
    curl -L -o /downloads/pyqt5.tar.gz http://versaweb.dl.sourceforge.net/project/pyqt/PyQt5/PyQt-${SPLASH_PYQT_VERSION}/PyQt-gpl-${SPLASH_PYQT_VERSION}.tar.gz && \
